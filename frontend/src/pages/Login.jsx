...
const Login = () => {
  const { backendurl, isLoading, setIsLoading, setUserData, setIsAuthenticated } = useContext(AppContext);
  ...
  return (
    <div>
      ...
      <div className="w-full min-h-[90dvh] p-3 sm:p-10 bg-gray-100 flex justify-center items-center">
        <form onSubmit={handleSubmit} className="w-full sm:w-[400px] p-10 bg-white rounded-xl shadow flex flex-col gap-2 sm:gap-3 justify-center items-center">
          {error && (
          ...
          <div className="flex flex-col justify-center items-center text-gray-500">
            ...
            <p className="">
              Move forward with <span className="text-blue-700 font-semibold">Taskify!</span>
            </p>
          </div>
          <Input
            label="Email"
          ...
          <div className="w-full">
            ...
            <p
              ...
              className="text-blue-700 underline cursor-pointer ">Forget password?</p>
          </div>
          <button
          onKeyDown={(e)=>{
